  ...
  return (
    <div className="border-b mb-6">
      <header className="py-4 px-6 flex justify-between items-center gap-10">
        ...
        md:static fixed bottom-0 md:w-auto w-screen md:bg-transparent bg-white left-0 md:border-t-0 border-t
        md:px-0 px-4 py-1
        ">
          <a href={"menu-link  "} className="menu-link flex flex-col hover:text-[#40a9ff] transition-all">
        ...
        {/* Mobile Menu    menu-linksden çıktık unutma büyük ekranda olmayacak */}
